	...
	Harvard University,\\
	Cambridge, MA, USA.\\
	%Webpage: http://goo.gl/mbYv7p
	\end{flushleft}
	}
	\hfill
	\begin{minipage}[c]{2.25in}	
	 \begin{center}
	  { \Large \textsc{\textcolor{blue}{Indrajeet S. Patil}}\\
	  \begin{small}
	(\tt patilindrajeet.science@gmail.com)\\
	(Twitter:\href{https://twitter.com/patilindrajeets?lang=en}{\tt \textcolor{red}{@patilindrajeets}})
	\end{small}}
	 \end{center}
	\end{minipage}
	\hfill
	...
	$\bullet$ \textbf{\textcolor{red}{Postdoctoral Fellow}}, Department of Psychology, \textcolor{blue}{Harvard University}, USA, 2017-.\\
	...
	$\bullet$ \textbf{\textcolor{red}{Bachelor of Science}} (Physics), \textcolor{blue}{Fergusson College}, University of Pune, India, 2005-2008 (Score: 83$\%$).\\
	...
	\begin{center}
	(*equal contribution, \href{https://scholar.google.it/citations?user=kSYuYTUAAAAJ&hl=en&oi=ao}{Citation count}: \textbf{\textcolor{red}{294}}, \textit{h}-index: \textbf{\textcolor{red}{8}}, \textit{i}10-index: \textbf{\textcolor{red}{6}}, \href{https://osf.io/hk5f3/}{Open data/scripts}: \textbf{\textcolor{red}{12/12}} publications)\\
	\end{center}
	...
	\heading{\textbf{Preprints (or in preparation)}} 
		...
		$\bullet$ \textbf{\textcolor{red}{Patil, I.}}*, Dhaliwal, N. A.*, \& Cushman, F. A. (In revision). Reputational and cooperative benefits of \hspace*{0.1in}third-party compensation. \textit{\textcolor{blue}{Journal of Personality and Social Psychology}}. \href{https://psyarxiv.com/c3bsj/}{\tt doi:10.17605/OSF.IO/C3BSJ}
	\miniskip
	
		$\bullet$ \textbf{\textcolor{red}{Patil, I.}}, \& Tr\'{e}moli\`{e}re, B. (Under review). I think, therefore I forgive: The role of reasoning in forgiving \hspace*{0.1in}accidental harms. \textit{\textcolor{blue}{Cognition}}. \href{https://psyarxiv.com/8gjth/}{\tt doi:10.17605/OSF.IO/8GJTH}
	\miniskip
...
%	$\bullet$ \textbf{\textcolor{red}{Patil, I.}}*, Zucchelli, M. M.*, Kool, W., Fornasier, F., Cal\`{o}, M., Silani, G., Cikara, M., \& Cushman, F. A. (in \hspace*{0.1in}preparation). Reasoning supports utilitarian inclinations while resolving moral dilemmas.
%	\miniskip

%	$\bullet$ \textbf{\textcolor{red}{Patil, I.}}*, Kool, W.*, Campbell, S.*, Silani, G., Cikara, M., \& Cushman, F. A. (in preparation). Moral \hspace*{0.1in}learning privileges model-free update.
%	\miniskip
...
%	$\bullet$ \href{http://www.repubblica.it/scienze/2017/04/11/news/area_cervello_perdono-162669836/?rss}{Il perdono \`{e} scritto nella mente: scoperta l'area del cervello, \textcolor{blue}{\textit{la Repubblica}}, April 11, 2017}.
	...
	\hspace*{0.1in} Statistical programming: \textcolor{blue}{R} (advanced)\\
	\hspace*{0.1in} Special skills (in R): text mining, machine learning, meta-analysis\\
	\hspace*{0.1in} Package development (in R):\\
	\hspace*{0.2in}\href{https://cran.r-project.org/web/packages/ggstatsplot/index.html}{\textcolor{blue}{ggstatsplot}} (on CRAN),\\
	\hspace*{0.2in}\href{https://github.com/IndrajeetPatil/groupedstats}{\textcolor{blue}{groupedstats}} (on CRAN)\\
	%Python (beginner); 
	\hspace*{0.1in} Miscellaneous: \textcolor{blue}{Git/GitHub} (intermediate), \textcolor{blue}{MATLAB} (beginner)
	%\textcolor{blue}{JavaScript} (beginner)
	\miniskip
	
	$\bullet$ \textcolor{red}{\textbf{Document preparation}}: \textcolor{blue}{\LaTeX{}}, \textcolor{blue}{RMarkdown}\\
	\miniskip
	
	$\bullet$ \textcolor{red}{\textbf{Statistical Analysis softwares}}\\
	\hspace*{0.1in}\textit{Classical}: \textcolor{blue}{SPSS}, \textcolor{blue}{jamovi}; \textit{Bayesian}: \textcolor{blue}{JASP}; \textit{Structural Equation Modelling}: \textcolor{blue}{Amos}; \textit{Power analysis}: \textcolor{blue}{G*Power}
	\miniskip
	...
	$\bullet$ \textcolor{red}{\textbf{Online data collection}}: \textcolor{blue}{Qualtrics}, \textcolor{blue}{MTurk}\\
	\miniskip
	...
	$\bullet$ Undergraduate thesis/Internship/Exchange students: Carlotta Cogoni (2013-14); Marta Cal\`{o}, Federico \hspace*{0.1in}Fornasier (2014-15); Jens Melsbach (2015-16); Micaela Maria Zucchelli (2017-18); Stephanie Campbell \hspace*{0.1in}(2017-18); Tom Osborn (2018).
...
%
%	$\bullet$ \textit{Moral learning privileges model-free update}. Social Psychology Lunch talk series, Harvard University, \hspace*{0.1in}Cambridge, MA, USA, November 27, 2018.\\
%	\miniskip	
%
...
%	$\bullet$ \textit{Neuroanatomical basis of concern-based altruism in virtual environment}. FASPDA Postdoc Symposium, \hspace*{0.1in}Harvard University, Cambridge, MA, USA, June 1, 2017.\\
	...
	\textcolor{blue}{{\hspace*{0.1in}Journal articles}}(59):\\
	\hspace*{0.1in}\textit{Social Cognitive \& Affective Neuroscience}(2), \textit{Scientific Reports}(5), \textit{Cognition}(1), \textit{Social Neuroscience}(1), 
