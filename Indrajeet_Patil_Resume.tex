	...
	$\bullet$ \textcolor{blue}{\textbf{Open-source software development}} (in R; published on \textbf{CRAN}; Total downloads: \textcolor{blue}{\textbf{149,629}}):
	 \vspace*{-0.09in}
...
%	$\bullet$ \textcolor{blue}{\textbf{Skin conductance data analysis}}: \textcolor{black}{Ledalab}
	...
	\hspace*{0.1in}\href{https://scholar.google.it/citations?user=kSYuYTUAAAAJ&hl=en&oi=ao}{Citations}: \textbf{\textcolor{red}{460}}, \textit{h}-index: \textbf{\textcolor{red}{9}}, \textit{i}10-index: \textbf{\textcolor{red}{9}}, \href{https://osf.io/hk5f3/}{Open materials} (13/13)\\
