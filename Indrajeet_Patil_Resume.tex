	...
	%\item[--] Created multiple R packages to analyze and visualize data.
	\end{itemize}
	\miniskip
	\vspace*{-0.09in}
...
%	$\bullet$ \textcolor{blue}{\textbf{Skin conductance data analysis}}: \textcolor{black}{Ledalab}
	...
	\hspace*{0.1in}\href{https://scholar.google.it/citations?user=kSYuYTUAAAAJ&hl=en&oi=ao}{Citations}: \textbf{\textcolor{red}{725}}, \textit{h}-index: \textbf{\textcolor{red}{11}}, \textit{i}10-index: \textbf{\textcolor{red}{12}}, \href{https://osf.io/hk5f3/}{Open materials} (13/13)\\
